// utils/emailService.ts - VERSIÓN COMPLETA
...
// 1. EXISTENTE: Email de recuperación de contraseña
...
// 2. EXISTENTE: Email de confirmación de cambio de contraseña
        ...
        <tr>
          <td align="center" style="padding: 40px 20px;">
            <table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse; background: linear-gradient(180deg, #003d5c 0%, #001f2f 100%); border-radius: 16px; box-shadow: 0 10px 40px rgba(0, 63, 92, 0.3); overflow: hidden;">
              ...
              <tr>
                <td style="padding: 0 30px 40px 30px;">
                  <table role="presentation" style="width: 100%; border-collapse: collapse; background: rgba(0, 62, 93, 0.4); border-radius: 12px; border: 1px solid rgba(0, 255, 157, 0.2); backdropFilter: blur(10px);">
                    <tr>
                      <td style="padding: 30px;">
                        <p style="margin: 0 0 18px 0; color: #e0f4ff; line-height: 1.7; font-size: 16px; text-align: center;">
...
// 3. NUEVO: Email de bienvenida (AÑADE ESTA FUNCIÓN)
export const sendWelcomeEmail = async (to: string, username: string): Promise<{ success: boolean; messageId?: string }> => {
  ...
  // URL del frontend
  const frontendUrl = process.env.FRONTEND_URL || 'https://el-gran-azul-c2d7.vercel.app';
        ...
        <tr>
          <td align="center" style="padding: 40px 20px;">
            <table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse; background: linear-gradient(180deg, #003d5c 0%, #001f2f 100%); border-radius: 16px; box-shadow: 0 10px 40px rgba(0, 63, 92, 0.3); overflow: hidden;">
              ...
              <tr>
                <td style="padding: 0 30px 40px 30px;">
                  <table role="presentation" style="width: 100%; border-collapse: collapse; background: rgba(0, 62, 93, 0.4); border-radius: 12px; border: 1px solid rgba(0, 242, 255, 0.2);">
                    <tr>
                      <td style="padding: 30px;">
                        <p style="margin: 0 0 18px 0; color: #e0f4ff; line-height: 1.7; font-size: 16px; text-align: center;">
...
Accede a tu cuenta aquí: ${frontendUrl}/login
...
© ${new Date().getFullYear()} El Gran Azul. Todos los derechos reservados.
  ...
  try {
    ...
    // Solo añade attachments si hay logo
